...
def img_txt(img):
    ...
    img = Image.open("/Users/dongshaobing/Desktop/书写数字识别/多个图片转文本/images/"+img)
...
def write(txt):
    #打开文本将要写入的文件
    label = txt[1].split("_")[0]
    file = open("/Users/dongshaobing/Desktop/书写数字识别/多个图片转文本/numbers_txt/"+label+".txt","a")
    for i in txt[0]:
        file.write(i)
